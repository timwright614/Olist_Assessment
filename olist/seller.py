...
class Seller:
    ...
    def get_review_score(self):
        ...
        seller_order = self.data['order_items'][['seller_id','order_id']].copy()
        seller_reviews = pd.merge(seller_order, reviews, on='order_id')

        seller_reviews_mean = seller_reviews.groupby(['seller_id']).mean().reset_index()
        seller_reviews_mean.columns = ['seller_id','share_of_five_stars','share_of_one_stars','review_score']

        return seller_reviews_mean
